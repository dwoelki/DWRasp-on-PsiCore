 ...
 *
 * <p>
 * This example implements the MCP223017 GPIO expansion board.
 ...
 */
public class Test_I2C_MCP23017 {
    ...
    public static void main(String args[]) throws InterruptedException, IOException, I2CFactory.UnsupportedBusNumberException {
        ...
        for (int i: I2CFactory.getBusIds())
            System.out.print("\t"+i);
        System.out.println();
        System.out.println("default address:\n\t"+MCP23017GpioProvider.DEFAULT_ADDRESS);
        System.out.println("default polling time:\n\t"+MCP23017GpioProvider.DEFAULT_POLLING_TIME);
        
        I2CBus bus = I2CFactory.getInstance(I2CFactory.getBusIds()[0]);
        I2CDevice device = bus.getDevice(0x20);
        
        System.out.println("device addr:\n\t"+device.getAddress());
        ...
        final MCP23017GpioProvider provider = new MCP23017GpioProvider(I2CFactory.getInstance(I2CFactory.getBusIds()[0]), 0x20);
        ...
        GpioPinDigitalInput myInputs[] = {
                ...
                //gpio.provisionDigitalInputPin(provider, MCP23S17Pin.GPIO_A4, "MyInput-A4", PinPullResistance.PULL_UP),
        ...
        GpioPinDigitalOutput ledPin = gpio.provisionDigitalOutputPin(provider, MCP23017Pin.GPIO_A4, "TheLEDPin@A4");
